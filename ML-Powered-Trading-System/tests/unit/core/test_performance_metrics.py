...
class TestPerformanceMetrics(unittest.TestCase):
    ...
    def test_calculate_sortino_ratio(self):
        ...
        expected_sortino = (np.mean(self.returns) - rf_per_period) / downside_deviation if downside_deviation > 0 else 0
        ...
        # Test with only positive returns (should give inf if mean > rf)
        positive_returns = [0.01, 0.02, 0.03]
        self.assertEqual(self.metrics.calculate_sortino_ratio(positive_returns, risk_free_rate=0.005), float('inf'))
    ...
    def test_calculate_kelly_criterion(self):
        ...
        # Expected: 0.6 - ((1 - 0.6) / (53.33/25.0)) = 0.6 - 0.4/2.13 = 0.6 - 0.188 = 0.412
        self.assertAlmostEqual(kelly, 0.412, places=3)
        ...
        # Kelly > 1 (should be capped at 1.0)
        self.assertEqual(self.metrics.calculate_kelly_criterion(0.9, 10.0), 1.0)
    ...
    @patch('performance_metrics.PerformanceMetrics.calculate_all_metrics')
